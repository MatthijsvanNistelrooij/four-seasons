...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
      key={id}
      className="group relative bg-white border border-indigo-200 rounded-2xl p-6 shadow-md hover:shadow-2xl transition-shadow duration-300 flex flex-col items-center"
    >
      <Image
        src={imageSrc}
        alt={imageAlt}
      ...
      <div className="flex flex-col gap-3 mt-6 w-full">
        <button
          ...
          className="w-full relative overflow-hidden rounded-full px-5 py-2.5 font-semibold text-white bg-gradient-to-r 
        ...
        <Link
          href={`/product/${handle}`}
          className="w-full relative overflow-hidden rounded-full px-5 py-2.5 font-semibold text-indigo-600 border
